      ...
      >
          ...
          >
            ...
            <div className="p-7 rounded-xl bg-white">
              <p className="py-4">Company helped to see great places with the great offers.<br/> The company also assure you to refund your money anytime. <br/> Easy to communicate easy to explore. Thank you.</p>
              <img src={Stars} alt="stars" />
              <p className="text-secondary-100 text-sm py-2">Luis M</p>
          ...
          >
            ...
            {/* <img src={Customer} className="rounded-full h-470" /> */}
